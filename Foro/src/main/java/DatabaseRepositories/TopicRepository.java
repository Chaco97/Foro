...
{
    @Query("Select t FROM Topic.java t WHERE t.title=:paramTitle or t.message=:paramMessage")
    public Topic findTopicByTitleOrMessage(String paramTitle, String paramMessage);

    @Query("Select t FROM Topic.java t ORDER BY creationDate DESC LIMIT 10")
